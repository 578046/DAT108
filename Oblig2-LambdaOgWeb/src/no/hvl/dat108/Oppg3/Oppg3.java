...
//		ansatte etter lønnsøkningen.
		System.out.println("d) Gi alle sjefer (stilling inneholder noe med \"sjef\") en lønnsøkning på 7% ved å\r\n" + 
				"bruke streams direkte i stedet for metoden du laget i Oppg2. Skriv ut listen av\r\n" + 
				"ansatte etter lønnsøkningen.");
		List<Ansatt> bossSalary = ansatte.stream().filter(a -> a.getStilling().toLowerCase().contains("sjef"))
				.collect(Collectors.toList());
		bossSalary.forEach(a -> a.setAarslonn((a.getAarslonn() + (a.getAarslonn() / 100) * 7)));
